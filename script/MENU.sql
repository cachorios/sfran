...
-- valorstr: en menus ppal es descripcion del menu, en menus secundarios es el nombre calificado de la clase vista que lo implementa --
        ...
        VALUES (1,  NULL, '2017-11-03', 'UNKNOW', 'UNKNOW', 'MENU.DDYR', 'Transporte',                     0, 2, FALSE, NULL, 0, 0, 'Gestion Vehiculos y choferes', 1),
           ...
           (91, NULL, '2017-11-03', 'UNKNOW', 'UNKNOW', 'MENU.PARA', 'Parametros Generales',         901, 2, FALSE, NULL, 8, 90, 'ar.com.sciolar.siddire.view.parametros.ParamView', 1),
           (92, NULL, '2017-11-03', 'UNKNOW', 'UNKNOW', 'MENU.PARA', 'Usuarios',                     902, 2, FALSE, NULL, 9, 90, 'ar.com.sciolar.siddire.view.usuarios.UsuarioView', 1);
