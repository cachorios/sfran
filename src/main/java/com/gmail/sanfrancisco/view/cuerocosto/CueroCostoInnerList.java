...
public class CueroCostoInnerList extends DefaultInnerListPolymer<CueroCosto> {
    ...
    public CueroCostoInnerList(IPresentableList<CueroCosto> presentable, String elTitulo) {
        super(presentable, elTitulo);

        pdfBtn = new ReportSelector("Imprimir", VaadinIcon.PRINT.create());

        pdfBtn.addform("Listado", "cuero.jrxml", this::formFilter);
