...
@Dependent
public class LicenciaDataProvider extends FilterablePageableDataProvider<Licencia,Long, String> {
    @Inject
    public LicenciaDataProvider(ServicioModelo<Licencia> servicio) {
