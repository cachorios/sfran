...
@Dependent
public class CueroCostoDataProvider extends FilterablePageableDataProvider<CueroCosto, Long, String> {
    @Inject
    public CueroCostoDataProvider(ServicioModelo<CueroCosto> servicio) {
